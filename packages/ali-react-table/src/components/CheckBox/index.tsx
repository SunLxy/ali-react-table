...
export const CheckBox = (props: CheckBoxProps) => {
  ...
  return (<CheckBoxWarp onClick={onClickItem} $disabled={disabled} $indeterminate={indeterminate} $checked={checked} className={cls}>
    <CheckBoxBody className="ali-simple-table-check-box-body">
      <CheckBoxBase className="ali-simple-table-check-box-input" type="checkbox" />
      <CheckBoxInner className="ali-simple-table-check-box-inner" />
    </CheckBoxBody>
  </CheckBoxWarp>)
}
...
const CheckBoxGroupItemBase = styled.div<{ $checked: boolean }>`
  ...
  ${props => props.$checked && css`
    background-color: var(--primary-color-active,#e6f4ff);
    border-radius: 4px;  
  `}
`
