        ...
        return {
          ...
          headerCellProps: mergeCellProps(col.headerCellProps, {
            onMouseDown: !isLeaf || path.length > 1 ? undefined : (e) => {
              ...
              const startScrollLeft = pipeline.ref.current.domHelper.tableBody.scrollLeft
              ...
              function handleMouseMove(e) {
                ...
                const scrollDistance = pipeline.ref.current.domHelper.tableBody.scrollLeft - startScrollLeft
              ...
              function handleMouseUp(e) {
                ...
                window.requestAnimationFrame(() => {
                  ...
                  if (onColumnDragStopped) {
                    const newColumns = sortColumns(columns, cloumnsSortData).filter((column) => column.code !== FILL_COLUMN_CODE && !isSelectColumn(column))
